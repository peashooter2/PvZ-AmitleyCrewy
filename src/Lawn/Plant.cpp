...
constinit const PlantDefinition gPlantDefs[SeedType::NUM_SEED_TYPES] = {
    ...
    { .mSeedType = SeedType::SEED_STARFRUIT,         .mPlantImage = nullptr, .mReanimationType = ReanimationType::REANIM_STARFRUIT,     .mPacketIndex = 30, .mSeedCost = 175, .mRefreshTime = 750,    .mSubClass = PlantSubClass::SUBCLASS_SHOOTER, .mLaunchRate = 150,  .mPlantName = "STARFRUIT" },
